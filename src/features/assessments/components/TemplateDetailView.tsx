...
export function TemplateDetailView({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-1 bg-slate-900 border border-slate-800 p-1 rounded-xl">
          <button
            ...
            className={`px-4 py-2 text-xs font-semibold rounded-lg transition-all ${activeTab === 'overview' ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'}`}
          >
            Overview
          </button>
          <button
            onClick={() => setActiveTab('questions')}
            className={`px-4 py-2 text-xs font-semibold rounded-lg transition-all ${activeTab === 'questions' ? 'bg-slate-800 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'}`}
          >
            Questions Builder
          </button>
        </div>
      ...
      {activeTab === 'overview' ? (
        /* Overview Workspace (Original Grid Layout) */
        ...
        <div className="rounded-3xl border border-surface-800 bg-surface-900/30 backdrop-blur-md p-6 sm:p-8 shadow-xl animate-fadeIn">
          <QuestionBuilderTab
